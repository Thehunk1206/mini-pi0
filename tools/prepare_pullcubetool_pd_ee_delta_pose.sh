...
# Prepare PullCubeTool-v1 motion-planning data for mini-pi0 training:
...
#
# Useful overrides:
#   COUNT=5 NUM_ENVS=4 bash tools/prepare_pullcubetool_pd_ee_delta_pose.sh
#   TARGET_CONTROL_MODE=pd_ee_delta_pose bash tools/prepare_pullcubetool_pd_ee_delta_pose.sh
#   SOURCE_H5=... ROBO_OUT=... bash tools/prepare_pullcubetool_pd_ee_delta_pose.sh
...
SOURCE_H5="${SOURCE_H5:-demos/maniskill/PullCubeTool-v1/motionplanning/trajectory.h5}"
WORK_DIR="${WORK_DIR:-demos/maniskill/PullCubeTool-v1/motionplanning_${TARGET_CONTROL_MODE}}"
ROBO_OUT="${ROBO_OUT:-data/robomimic/maniskill/pullcubetool/mp/rgbd_${TARGET_CONTROL_MODE}.hdf5}"
...
echo "[1/2] Replaying PullCubeTool-v1 with rgbd + ${TARGET_CONTROL_MODE}, physx_cpu, num-envs=${NUM_ENVS}"
