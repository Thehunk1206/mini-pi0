...
class EndEffector3DVisualizer:
    ...
    def log(
        ...
        actual_links = self.urdf_model.link_positions(actual_joint_positions)
        target_links = self.urdf_model.link_positions(target_joint_positions)
