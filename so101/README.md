...
| [`policy_inference/`](policy_inference/README.md) | Dual-camera 16M/25M mini-pi0 deployment with asynchronous LeRobot RTC, calibrated safety, and Rerun | `python -m so101.policy_inference` |
