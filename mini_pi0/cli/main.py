...
def _apply_eval_overrides(args: argparse.Namespace) -> list[str]:
    ...
    _append_override(overrides, "eval.vectorized", args.vectorized)
    _append_override(overrides, "eval.num_envs", args.num_envs)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p_eval.add_argument("--vectorized", action=argparse.BooleanOptionalAction, default=None)
    p_eval.add_argument("--num_envs", type=int, default=None)
    ...
    p_rl = sub.add_parser("rl-train", help="Fine-tune an FM checkpoint with PPO in Isaac Lab")
