...
| Task | Policy | Success | Checkpoint size | Directory |
| --- | --- | ---: | ---: | --- |
| StackCube-v1 | FM transformer + ViT medium, hist2, `pd_joint_pos` | 95.5% | 1,222,775,822 bytes | [`stackcube-vit-medium-hist2-pd-joint-pos`](stackcube-vit-medium-hist2-pd-joint-pos) |
| PegInsertionSide-v1 | FM transformer + ViT medium, hist3, hole cameras and contacts, `pd_ee_delta_pose` | 10.0% | 1,222,750,350 bytes | [`peginsertion-vit-medium-hist3-holecam-contacts`](peginsertion-vit-medium-hist3-holecam-contacts) |
| StackPyramid-v1 | FM transformer + ViT medium, hist2, `pd_ee_delta_pose` | 26.0% | 1,222,754,702 bytes | [`stackpyramid-vit-medium-hist2-pd-ee-delta-pose`](stackpyramid-vit-medium-hist2-pd-ee-delta-pose) |
| PullCubeTool-v1 | FM transformer + ViT small, hist2, `pd_ee_delta_pose` | 31.0% | 783,486,254 bytes | [`pullcubetool-vit-small-hist2-pd-ee-delta-pose`](pullcubetool-vit-small-hist2-pd-ee-delta-pose) |
